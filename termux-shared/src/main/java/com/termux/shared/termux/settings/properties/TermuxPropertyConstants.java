...
public final class TermuxPropertyConstants {
    ...
    public static final String DEFAULT_IVALUE_EXTRA_KEYS = "[['DRAWER', 'ESC', '</>', '-', 'HOME', {key: 'UP', display: '▲'}, 'END', 'PGUP', 'PASTE'], ['TAB', 'CTRL', 'ALT', {macro: 'exit\n', display: 'EXIT'}, {key: 'LEFT', display: '◀'}, {key: 'DOWN', display: '▼'}, {key: 'RIGHT', display: '▶'}, 'PGDN', {key: 'KEYBOARD', popup: {macro: 'CTRL c'}}]]";
