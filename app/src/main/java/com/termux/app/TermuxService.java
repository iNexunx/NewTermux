...
import com.newtermux.features.PhantomProcessGuard;
...
public final class TermuxService extends Service implements AppShell.AppShellClient, TermuxSession.TermuxSessionClient {
    ...
    public void onCreate() {
        ...
        // Best-effort silent disable of the Android 12+ phantom process monitor (signal 9 kills),
        // using WRITE_SECURE_SETTINGS if granted or root if available.
        PhantomProcessGuard.enforce(this);
